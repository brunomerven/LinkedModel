...
$   IFI %INTEXT_ONLY% == YES $BATINCLUDE preponly.mod YES
...
* Integration of UC_COMxxx
 ...
 UC_COM(UC_N,'NET',SIDE,R,DATAYEAR,C,S,'COMCON')$UC_ATTR(R,UC_N,SIDE,'COMCON','NET') $= UC_COMCON(UC_N,SIDE,R,DATAYEAR,C,S)*(-1);
...
* Prepare flags for flow tax/sub
 ...
 FLO_TAX(R,'%DFLBL%',P,C,S,CUR)$((NOT FLO_TAX(R,'%DFLBL%',P,C,S,CUR))$OBJ_VFLO(R,P,C,CUR,'SUB')) = 3;
 FLO_SUB(R,'%DFLBL%',P,C,S,CUR)$((NOT FLO_SUB(R,'%DFLBL%',P,C,S,CUR))$OBJ_VFLO(R,P,C,CUR,'SUB')) = 3;
*-----------------------------------------------------------------------------
...
* General attributes
*-----------------------------------------------------------------------------
*$BATINCLUDE prepparm G_CHNGMONY 'R' 'CUR' ",'0','0','0','0','0'" MODLYEAR 1
*$BATINCLUDE prepparm G_DRATE 'R' 'CUR' ",'0','0','0','0','0'" MODLYEAR 1
*-----------------------------------------------------------------------------
* Capacity related attributes (9)
*-----------------------------------------------------------------------------
...
*-----------------------------------------------------------------------------
$BATINCLUDE prepparm OBJ_COMNT 'R' 'C,TS,COSTYPE,CUR' ",'0','0'" MILESTONYR 1 0
$BATINCLUDE prepparm OBJ_COMPD 'R' 'C,TS,COSTYPE,CUR' ",'0','0'" MILESTONYR 1 0
*-----------------------------------------------------------------------------
...
$BATINCLUDE fillparm NCAP_CEFF 'R' 'P,CG1,CG2' ",'0','0','0'" V 'RTP(R,V,P)' 'GE 0'
...
*-----------------------------------------------------------------------------
$BATINCLUDE fillparm COM_AGG 'R' 'C,COM' ",'0','0','0','0'" MILESTONYR 1 'GE 0'
$BATINCLUDE fillparm COM_ELAST 'R' 'C,TS,BD' ",'0','0','0'" MILESTONYR 1 'GE 0'
$BATINCLUDE fillparm COM_FR 'R' 'C,TS' ",'0','0','0','0'" MILESTONYR 1 'GE 0' X_RCS
$BATINCLUDE fillparm COM_IE 'R' 'C,TS' ",'0','0','0','0'" MILESTONYR 1 'GE 0'
$BATINCLUDE fillparm COM_PKFLX 'R' 'C,TS' ",'0','0','0','0'" MILESTONYR 1 'GE 0'
$BATINCLUDE fillparm COM_PKRSV 'R' 'C' ",'0','0','0','0','0'" MILESTONYR 1 'GE 0'
$BATINCLUDE fillparm COM_PROJ 'R' 'C' ",'0','0','0','0','0'" MILESTONYR 1 'GE 0'
$BATINCLUDE fillparm COM_VOC 'R' 'C,BD' ",'0','0','0','0'" MILESTONYR 1 'GE 0'
*-----------------------------------------------------------------------------
* Flow related attributes & inter-regional exchange
*-----------------------------------------------------------------------------
$BATINCLUDE fillparm FLO_FEQ 'R' 'P,C' ",'0','0','0','0'" V 'RVP(R,V,P)' 'GE 0'
...
$BATINCLUDE prepparm PRC_MARK 'R' 'P,ITEM,C,BD' ",'0'" MILESTONYR 1 1 11
...
* User constraints
*-----------------------------------------------------------------------------
$BATINCLUDE fillparm UC_ACT 'UC_N,SIDE,R' 'P,TS' ",'0','0'" MILESTONYR 1 'GE 0'
$BATINCLUDE fillparm UC_CAP 'UC_N,SIDE,R' 'P' ",'0','0','0'" MILESTONYR 1 'GE 0'
$BATINCLUDE fillparm UC_COM 'UC_N,COM_VAR,SIDE,R' 'C,TS,UC_GRPTYPE' "" MILESTONYR 1 'GE 0'
$BATINCLUDE fillparm UC_FLO 'UC_N,SIDE,R' 'P,C,TS' ",'0'" MILESTONYR 1 'GE 0'
$BATINCLUDE fillparm UC_IRE 'UC_N,SIDE,R' 'P,C,TS,IE' "" MILESTONYR 1 'GE 0'
$BATINCLUDE fillparm UC_NCAP 'UC_N,SIDE,R' 'P' ",'0','0','0'" MILESTONYR 'RTP(R,MILESTONYR,P)' 'GE 0'
$BATINCLUDE filparam UC_TIME 'UC_N,R,' '' ",'0','0','0'" DATAYEAR T '' '' '' "ALLY,"
*=============================================================================
******* NON-REGULAR NON-COST PARAMETERS: NOT interpolated by default *********
*-----------------------------------------------------------------------------
* Capacity and commodity related attributes
*-----------------------------------------------------------------------------
$BATINCLUDE prepparm CAP_BND 'R' 'P,BD' ",'0','0','0'" MILESTONYR 'RTP(R,MILESTONYR,P)' 1
$BATINCLUDE prepparm NCAP_BND 'R' 'P,LIM' ",'0','0','0'" MILESTONYR 'RTP(R,MILESTONYR,P)' 1
$BATINCLUDE prepparm COM_BNDNET 'R' 'C,TS,BD' ",'0','0'" MILESTONYR 1 1
$BATINCLUDE prepparm COM_BNDPRD 'R' 'C,TS,BD' ",'0','0'" MILESTONYR 1 1
*-----------------------------------------------------------------------------
* Flow related attributes & inter-regional exchange
*-----------------------------------------------------------------------------
$BATINCLUDE prepparm ACT_BND 'R' 'P,TS,BD' ",'0','0'" MILESTONYR 'RTP(R,MILESTONYR,P)' 1
$BATINCLUDE prepparm FLO_BND 'R' 'P,CG,TS,BD' ",'0'" MILESTONYR 'RTP(R,MILESTONYR,P)' 1
$BATINCLUDE prepparm FLO_FR 'R' 'P,C,TS,LIM' ",'0'" MILESTONYR 'RTP(R,MILESTONYR,P)' 1
$BATINCLUDE prepparm FLO_SHAR 'R' 'P,C,CG,TS,BD' "" V 'RVP(R,V,P)' 1 '' +
$BATINCLUDE prepparm IRE_BND 'R' 'C,TS,ALL_REG,IE,BD' "" MILESTONYR 1 1
$BATINCLUDE prepparm IRE_XBND 'ALL_REG' 'C,TS,IE,BD' ",'0'" MILESTONYR 1 1
*-----------------------------------------------------------------------------
* Storage attributes
*-----------------------------------------------------------------------------
$BATINCLUDE prepparm STGIN_BND 'R' 'P,C,S,BD' ",'0'" MILESTONYR 'RTP(R,MILESTONYR,P)' 1
$BATINCLUDE prepparm STGOUT_BND 'R' 'P,C,S,BD' ",'0'" MILESTONYR 'RTP(R,MILESTONYR,P)' 1
*-----------------------------------------------------------------------------
* User constraints
*-----------------------------------------------------------------------------
$BATINCLUDE prepparm UC_RHSRT 'ALL_R,UC_N' 'LIM' ",'0','0','0'" MILESTONYR 1 1
$BATINCLUDE prepparm UC_RHSRTS 'ALL_R,UC_N' 'TS,LIM' ",'0','0'" MILESTONYR 1 1
$BATINCLUDE prepparm UC_RHST 'UC_N' 'LIM' ",'0','0','0','0'" MILESTONYR 1 1
$BATINCLUDE prepparm UC_RHSTS 'UC_N' 'TS,LIM' ",'0','0','0'" MILESTONYR 1 1
$BATINCLUDE prepparm REG_BNDCST 'R' 'COSTAGG,CUR,BD' ",'0','0'" MILESTONYR 1 1
*-----------------------------------------------------------------------------
...
$   IFI %INTEXT_ONLY%==YES  $BATINCLUDE preponly.mod NO
*=============================================================================
***************************** SHAPE/MULTI INDEXES ****************************
*-----------------------------------------------------------------------------
...
$BATINCLUDE preshape COM_ELASTX 'R' 'C,BD' ",'0','0','0'" MILESTONYR UNCD7 1 15
...
*-----------------------------------------------------------------------------
* We are done.
* All non-cost parameters have now been fully interpolated/extrapolated.
* All explicit interpolation options for the parameters scanned above have been processed.
* A second interpolation pass is still needed for cost parameters (dense interpolation).
*-----------------------------------------------------------------------------
OPTION CLEAR = UNCD7;
*-----------------------------------------------------------------------------
* Augment datayear to cover MILESTONYR, as any MODLYEAR may now contain user data.
* The special year should now be removed from DATAYEAR, as the controls are fully processed.
...
$BATINCLUDE fillvint PRC_ACTFLO 'R' 'P,CG' X_RPG

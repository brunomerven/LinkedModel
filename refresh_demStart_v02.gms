...
file mcdem_start2;
$gdxin w_ifa.gdx
$load  XC AY TT TC A QAX COM FS FH FT H MFHHT MFSA TFHPOP_X SIM_DEMX Passengerkm Tonkm

$call   "gdxxrw i=SATM\DMD_PRJ.xlsx o=dmd_prj_temp.gdx index=Index_E2G!a6 checkdate"
$gdxin  dmd_prj_temp.gdx
$load PKMFH

SFORE_X(FS,TC) = SUM(A$MFSA(FS,A), QAX(A,'base',TC,'2050'));


*$GDXout mcdem_start2.gdx
*$unload MFHHT TFHPOP_X SIM_DEMX PKMFH Passengerkm Tonkm
